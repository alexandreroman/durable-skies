...
1. takeoff_drone(drone_id="{drone_id}", fleet_workflow_id="{fleet_workflow_id}")
2. navigate_drone(drone_id="{drone_id}", from_point_id="{home_base_id}", \
to_point_id="{pickup_base_id}", fleet_workflow_id="{fleet_workflow_id}", \
kind="to_target")
3. pickup_package(drone_id="{drone_id}", order_id="{order_id}", \
base_id="{pickup_base_id}", fleet_workflow_id="{fleet_workflow_id}")
4. navigate_drone(drone_id="{drone_id}", from_point_id="{pickup_base_id}", \
to_point_id="{dropoff_point_id}", fleet_workflow_id="{fleet_workflow_id}", \
kind="to_target")
5. dropoff_package(drone_id="{drone_id}", order_id="{order_id}", \
dropoff_point_id="{dropoff_point_id}", fleet_workflow_id="{fleet_workflow_id}")
6. navigate_drone(drone_id="{drone_id}", from_point_id="{dropoff_point_id}", \
to_point_id="{home_base_id}", fleet_workflow_id="{fleet_workflow_id}", \
kind="returning")
7. land_drone(drone_id="{drone_id}", fleet_workflow_id="{fleet_workflow_id}")

Always pass the drone_id and fleet_workflow_id exactly as shown above.
